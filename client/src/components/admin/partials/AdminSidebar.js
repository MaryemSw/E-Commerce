    ...
    <Fragment>
      ...
      >
        ...
        <div
          ...
          className={`${
            location.pathname === "/admin/dashboard/contacts"
              ? "border-r-4 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          ...
          <span className="hover:text-gray-800">Contacts</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
          onClick={(e) => history.push("/admin/dashboard/admins")}
          className={`${
        ...
        >
          ...
          <span className="hover:text-gray-800">Admins</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
